...
import { Box, Button, Heading, Text, MetaMaskButton } from "rimble-ui";
import './App.css';
...
class App extends Component {
  ...
  async loadBlockchainData(dispatch) {
    if (typeof window.ethereum!=='undefined'){
      ...
      const netId =  await web3.eth.net.getId();//identify the eth network
